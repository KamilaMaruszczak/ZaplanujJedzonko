...
<div class="row border-bottom border-3 p-1 m-1">
    ...
    <div class="col d-flex justify-content-end mb-2 noPadding">
        <input type="submit" form="addMeal" value="Zapisz" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4"/>
    </div>
</div>

<div class="schedules-content">
<form:form modelAttribute="meal" id="addMeal" method="post" action="/app/addmeal">
    <div class="form-group row">
    <label for="choosePlan" class="col-sm-2 label-size col-form-label">
    Wybierz plan
    </label>
    <div class="col-sm-3">
    <form:select path="" class="form-control" id="choosePlan">
